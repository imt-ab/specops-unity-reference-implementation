...
These files are **not runtime code** and are **not architecture definitions**.
They are instructions and tooling artifacts used by AI agents (Codex, Junie, Claude) to maintain consistency.
