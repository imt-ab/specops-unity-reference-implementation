...
The seven logical Skill artifacts and `.specops/*` structures planned for later slices are not installed by E1 and are not assumed by this deployment document.
