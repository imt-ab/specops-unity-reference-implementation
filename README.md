...
- The development repository for a reference implementation whose latest
  published Golden Baseline can be used to bootstrap disciplined Unity projects.
...
For stable project bootstrap, use the published release source rather than
`main`. The root [INSTALL.md](INSTALL.md) describes the supported installation
path.
