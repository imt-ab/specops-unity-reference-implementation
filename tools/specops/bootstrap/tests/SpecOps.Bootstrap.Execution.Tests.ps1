...
try {
    ...
    Assert-Equal Source 'clean mirror governed leaves' $mirror.Paths.Count 405
    ...
    Assert-Equal CLI 'success Source Identity' $successJson.sourceIdentity.digest '90f8d9a50c159dc08245f94c631953e9c70a9ced8c22fcd73ad5e55fd2d49c56'
...
$result=[ordered]@{Result=$(if($script:Failures.Count){'FAIL'}else{'PASS'});Tests=$script:Tests;Categories=$script:Categories;Failures=@($script:Failures);RegularLeafCount=405;AuthoredFiles=397;ImplementationSupportFiles=6;OutputCount=312;SourceIdentity='90f8d9a50c159dc08245f94c631953e9c70a9ced8c22fcd73ad5e55fd2d49c56';ImplementationVersion='1.0.0';UnityExecuted=$false;RealHumanDestinationUsed=$false;GitRequired=$false}
