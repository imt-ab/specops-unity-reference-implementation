...
function New-CanonicalFixture{
 ...
 foreach($relative in @('tools/specops/Invoke-SpecOps.ps1','tools/specops/SpecOps.Repository.psm1','tools/specops/SpecOps.Eval.psm1')){Copy-Item (Join-Path $ProducerSourceRoot $relative) (Join-Path $Path $relative) -Force}
